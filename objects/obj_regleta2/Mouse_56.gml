...
// una nueva regleta si la cantidad de regletas es menor que la cantidad máxima
if (cantidad_regletas < cantidad_regletas_maxima) {
  instance_create_layer(posicion_original[0], posicion_original[1], "Instances", obj_regleta2);
  cantidad_regletas++;
}